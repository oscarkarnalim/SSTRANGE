...
public class PythonHtmlGenerator {
	public static void generateHtmlForSSTRANGE(String codepath1, String codepath2,
			...
			String languageCode, ArrayList<ArrayList<String>> additionalKeywords, ArrayList<GSTMatchTuple> matches)
			throws Exception {
		 ...
		 * uses the same data as formatted code with comments.
		 */
		String[] formattedInfoStringsWithoutComments = generateInformationStrings(codepath1, codepath2,
				"syontablecontent", "syon", false, languageCode);
	...
	private static String[] generateInformationStrings(String filepath1, String filepath2, String tableId, String mode,
		...
		if (mode.equals("syon")) {
			code1 = readCode1WithoutComment(filepath1, gSyntaxMessage, commentString1, tableId);
			code2 = readCode2WithoutComment(filepath2, gSyntaxMessage, commentString2, tableId);
		} else {
