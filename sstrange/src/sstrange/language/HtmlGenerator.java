...
public class HtmlGenerator {
	/*
	 * This is a generic class for handling HTML generation
	 */
	...
	public static void generateHtmlForSSTRANGE(String codepath1, String codepath2,
			...
			int sameClusterOccurrences, String languageCode, 
			ArrayList<GSTMatchTuple> matches) throws Exception {

		// get syntax reordering messages
		ArrayList<FeedbackMessage> gSyntaxMessage = FeedbackMessageGenerator.generateSimilarityMessages(tokenString1, tokenString2, minimumMatchLength, languageCode, matches);

		String[] defaultInfoStrings = generateInformationStrings(codepath1, codepath2, "origtablecontent", "",
				languageCode, gSyntaxMessage);
	...
	private static String[] generateInformationStrings(String filepath1, String filepath2, String tableId, String mode,
			String humanLanguageId, ArrayList<FeedbackMessage> gSyntaxMessage) throws Exception {
